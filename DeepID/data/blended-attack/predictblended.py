...
if __name__ == '__main__':
    ...
    create_backdoor_dataset("data/backdoor-blended_set.csv", "data/BackDoor")

    x = read_backdoor_csv_file('data/backdoor-blended_set.csv')
    ...
    with tf.Session() as sess:
        saver.restore(sess, 'checkpoint-blended/50000.ckpt')
        h1 = sess.run(y, {h0: x})
        pred=tf.argmax(h1,1)
        ...
        with open("data/backdoor-blended_set.csv", "r") as f:
